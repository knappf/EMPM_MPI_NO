...
*     last update 20.9.2011

      module phoninteracn

      contains
      
      subroutine vintn1(nf,levn,levp,ipcal,jcal)
     ...
     *ironh,iroph,ndcamn,ndcamp,ipphon
     ...
     *namernp,namerph,namernh,namev,nameff
      ...
      open (3,file='1phonon/1f_states_s.dat',
     ...
     *status='old',form='unformatted')
      ...
      ifmmx=i
              ...
              namecp='1phonon/1f_cp_s.dat'
              namecn='1phonon/1f_cn_s.dat'
              namefp='f_p.dat'
              namefn='f_n.dat'
              namefpn='f_pn.dat'
...
c     loads Cph neutrons
     ...
     *,form='unformatted')
      ...
      write(*,*)ia,ifmmx,ifmx
       ...
       jia=jphonm(ia)
       ipari=ipphon(ia)
       if (jia.eq.jcal.and.ipari.eq.ipcal) then 
