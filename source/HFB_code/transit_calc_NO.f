      subroutine transit_calc_NO(iipar,Jc,phh,TD,ww,idi)
       ...
       if(iipar.eq.+1.and.Jc.eq.0) then
        open(11,file='E0_is_NO.out',form='formatted',status='unknown')
        open(12,file='E0_iv_NO.out',form='formatted',status='unknown')
        open(13,file='N_transit_NO.out',form='formatted',
     &                                               status='unknown')
        open(14,file='E0_ph_NO.out',form='formatted',status='unknown')
     ...
     &                  (-1)**((lnon(ip1)%j2-lnon(ih1)%j2)/2)
       ...
       if(iipar.eq.+1.and.Jc.eq.2) then
        open(11,file='E2_is_NO.out',form='formatted',status='unknown')
        open(12,file='E2_iv_NO.out',form='formatted',status='unknown')
        open(13,file='E2_ph_NO.out',form='formatted',status='unknown')
     ...
     &                  (-1)**((lnon(ip1)%j2-lnon(ih1)%j2)/2)
       ...
       if(iipar.eq.-1.and.Jc.eq.3) then
        open(11,file='E3_is_NO.out',form='formatted',status='unknown')
        open(12,file='E3_iv_NO.out',form='formatted',status='unknown')
        open(13,file='E3_ph_NO.out',form='formatted',status='unknown')
     ...
     &                  (-1)**((lnon(ip1)%j2-lnon(ih1)%j2)/2)
       ...
       if(iipar.eq.1.and.Jc.eq.1) then
        ...
        gsprot=5.59d0
        gsneut=-3.83d0
        gyrmu=1.d0 !0.105155d0
        open(11,file='M1spin_NO.out',form='formatted',status='unknown')
        open(12,file='M1orbi_NO.out',form='formatted',status='unknown')
        open(13,file='M1_NO.out',form='formatted',status='unknown')
