...
!     double precision, dimension(:,:,:,:,:), allocatable :: rnp,rpp,rnh,rph
      ...
      real, dimension(:,:,:,:,:), allocatable :: rpp,rnp,rph,rnh
...
!************************************************************************
      ...
      type (roc_typ), dimension(:), allocatable :: rom
...
!      double precision, dimension(:,:,:,:,:), allocatable :: rnp,rpp,rnh,rph
      real, dimension(:,:,:,:,:), allocatable :: rnp,rpp,rnh,rph
