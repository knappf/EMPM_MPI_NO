     ...
     allocate(csixjd(0:jmx,0:jmx,0:jmx,0:jmx,0:jmx))
      ...
      do i=1,idphontr
       ...
       if (iaa.ne.iaaold) then
        call readfn(331,iaa,fnp,ndla,n1mn,n1mx,n2mn,n2mx,nsi)
        call readfn(341,iaa,fpp,ndla,n1mn,n1mx,n2mn,n2mx,nsi)
        call readfn(431,iaa,fnh,ndla,n1mn,n1mx,n2mn,n2mx,nsi)
        call readfn(441,iaa,fph,ndla,n1mn,n1mx,n2mn,n2mx,nsi)
!        iaaold=iaa
!       endif
!  
!       if (iaa.ne.iaaold) then
        call readro11(332,iaa,ronp1,ndla,n1mn,n1mx,n2mn,n2mx,nsi)
        call readro11(342,iaa,ropp1,ndla,n1mn,n1mx,n2mn,n2mx,nsi)
        call readro11(432,iaa,ronh1,ndla,n1mn,n1mx,n2mn,n2mx,nsi)
        call readro11(442,iaa,roph1,ndla,n1mn,n1mx,n2mn,n2mx,nsi)
        iaaold=iaa
       endif
